                    ...
                    <ul class="navbar-nav float-right">   
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" aria-current="page"><i class="ti-user m-r-5 m-l-5"></i> Perfil</a>
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-bulletin-board"></i><span class="hide-menu">Vendas </span></a>
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="employees_screen.html" class="sidebar-link"><i class="mdi mdi-account"></i><span class="hide-menu"> Funcionários </span></a></li>
                            </ul>
                        </li>                        
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="under_construction.html" aria-expanded="false"><i class="mdi mdi-scale-balance"></i><span class="hide-menu"> Contas a pagar </span></a></li>      
