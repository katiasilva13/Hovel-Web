                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Usuário" aria-label="usuario" name="usuario" id="username" autocomplete="off"aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-warning text-white" id="basic-addon2"><i class="ti-pencil"></i></span>
                                    </div>
                                    <input type="password" class="form-control form-control-lg" placeholder="Senha" aria-label="senha" name="senha" id="new-password" autocomplete="off" aria-describedby="basic-addon1" required="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" action="home.php">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg" placeholder="Email" aria-label="email" aria-describedby="basic-addon1">
                            </div>
                            <!-- pwd -->
